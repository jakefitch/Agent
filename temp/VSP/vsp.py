...
def open_new_claim(automation):
    try:
        ...
        print(f"Error in open_new_claim: {e}")
        # Don't re-raise the exception to prevent Selenium from closing
...
def submit_steps(automation):
    try:
        ...
        print(f"Error in submit_steps: {e}")
        # Don't re-raise the exception to prevent Selenium from closing
...
def look_for_member(automation, member):
    try:
        ...
        if member.active == False:
            ...
            print(error_msg)
            # Don't raise exception, just return to prevent Selenium from closing
            return
        ...
        print(f"Error in look_for_member: {e}")
        # Don't re-raise the exception to prevent Selenium from closing
...
def ai_search_vsp(automation, member):
    try:
        ...
        print(f"Error in ai_search_vsp: {e}")
        # Don't re-raise the exception to prevent Selenium from closing
...
def delete_authorizations(automation, member):
    try:
        ...
        print(f"Error in delete_authorizations: {e}")
        # Don't re-raise the exception to prevent Selenium from closing
...
def click_member(automation, member):
    try:
        ...
        print(f"Error in click_member: {e}")
        # Don't re-raise the exception to prevent Selenium from closing
...
def issue_new_auth_for_appropriate_services(automation,member):  #-------------------------------------------------------- I think this function should say member.active not memeber.authorization
    try:
        ...
        print(f"Error in issue_new_auth_for_appropriate_services: {e}")
        # Don't re-raise the exception to prevent Selenium from closing
...
def calculate_order(automation,member,second_window):
    try:
        ...
        print(f"Error in calculate_order: {e}")
        # Don't re-raise the exception to prevent Selenium from closing
...
def scrape_invoice(automation,member):
    try:
        ...
        print(f"Error in scrape_invoice: {e}")
        # Don't re-raise the exception to prevent Selenium from closing
...
def open_vsp_benefit(automation,member):
    try:
        ...
        print(f"Error in open_vsp_benefit: {e}")
        # Don't re-raise the exception to prevent Selenium from closing
...
def get_vsp_auth_from_rev(automation,member):
    try:
        ...
        print(f"Error in get_vsp_auth_from_rev: {e}")
        # Don't re-raise the exception to prevent Selenium from closing
...
def get_member_information_to_search_VSP(automation,member):
    ...
    #print(f'member list is {member.member_list}')
        ...
        print(f"Error in get_member_information_to_search_VSP: {e}")
        # Don't re-raise the exception to prevent Selenium from closing
...
def get_eyewear_order(automation, member):
    try:
        ...
        print(f"Error in get_eyewear_order: {e}")
        # Don't re-raise the exception to prevent Selenium from closing
...
def close_all_patient_tabs(automation):
    ...
    try:
        ...
        print(f"Error in close_all_patient_tabs: {e}")
        # Don't re-raise the exception to prevent Selenium from closing