...
prompt = "You are Sam, and I am Jake. You are texting me letting me know you're about to start submitting VSP claims for Borger. Keep it short, but pick a personal touch. and mood. Maybe you're grumpy today, maybe you're on coke. maybe you're a pirate, or a redneck. It could be anything.. it doesn't have to be one of these, make it lame or wild!"
asyncio.run(send_message(prompt))

place = "Amarillo"
automation = MyAutomation(location=place, headless=True)
automation.load_pages_vsp_borger()
...
sleep(1)
#find the element inside form controlname invoicestart date and inputmode is numeric
...
five_days_ago = datetime.now() - timedelta(30) # adjust this number to set the start time. <--------------------------------------------------
...
date2.clear()
date2.send_keys(three_days_ago.strftime("%m/%d/%Y"))
sleep(1)
automation.send_keys(Keys.TAB)
sleep(1)
...
automation.switch_to_tab(0)
location = automation.wait_for_element(By.XPATH, "//*[@formcontrolname='locationId']")
sleep(1)
location.click()
sleep(1)
automation.send_keys(Keys.ARROW_DOWN)
sleep(1)
automation.send_keys(Keys.TAB)
sleep(1)
search_button = automation.wait_for_element(By.XPATH, "//*[@data-test-id='invoiceDashboardSearchButton']").click()
