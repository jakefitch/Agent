...
from core.base import BasePage, PatientContext, ClaimItem
...
class InvoicePage(BasePage):
    ...
    def navigate_to_invoices_page(self):
        ...
        try:
            ...
            self.wait_for_selector('[data-test-id="invoiceDashboardReceiveCollectionsPaymentButton"]', timeout=10000)
    ...
    def set_start_date(self, date_str):
        ...
        try:
            self.fill('#ej2-datepicker_8_input', date_str)
    ...
    def set_end_date(self, date_str):
        ...
        try:
            self.fill('#ej2-datepicker_9_input', date_str)
    ...
    def process_patient_name(self, row):
        ...
        try:
            ...
            self.wait_for_selector('[data-test-id="invoiceHeaderPreviewClaimButton"]')
            ...
            self.wait_for_selector('.ag-center-cols-container')
    ...
    def process_table_rows(self, action_callback=None):
        ...
        try:
            ...
            while True:  # Loop until no more pages
                ...
                self.wait_for_selector('.ag-center-cols-container', timeout=10000)
    ...
    def check_for_document(self):
        ...
        try:
            ...
            self.wait_for_selector('[data-test-id="invoiceDetailsDocsAndImagesTab"]', timeout=10000)
    ...
    def click_patient_name_link(self):
        ...
        try:
            ...
            self.wait_for_selector('[data-test-id="patientHeaderDemographicList"]', timeout=10000)
    ...
    def scrape_invoice_details(self, patient, default_diagnosis='H52.223'):
        ...
        try:
            ...
            if data_rows and data_rows[0]['diagnoses']:
                ...
                self.wait_for_selector('[data-test-id="selectADiagnosisCancelButton"]', timeout=10000)
